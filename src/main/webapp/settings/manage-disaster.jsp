    ...
    <body>
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><h4>灾情获取匹配式管理<span class="caret"></span></h4></a>
        ...
        <script>
            ...
            function uploadFile(op) {
                ...
                var FileController = "<%=request.getContextPath()%>/UploadServlet?type=disaster&op=" + op;                // 接收上传文件的后台地址
