    ...
    <body>
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><h4>白名单管理<span class="caret"></span></h4></a>
        ...
        <script>
            ...
            function uploadFile() {
                ...
                var FileController = "<%=request.getContextPath()%>/UploadServlet?type=whitelist";            // 接收上传文件的后台地址
