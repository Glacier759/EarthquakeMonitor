                ...
                try {
                    ...
                    for (Element element : elements) {
                        try {
                            ...
                            Scheduler.insertRecord(Scheduler.SIGN_URL, resultLink, Scheduler.SERVICE_BBS_SEARCH, rule_id, SpiderInfo.FILTER_DISASTER);
                            ...
                            if (ans) {
                                ...
                                spiderInfo.setOrigin(SystemConfig.CONFIG_TYPE_BBS_SEARCH);
                                //设置好属性后插入数据库
